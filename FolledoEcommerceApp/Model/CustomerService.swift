...
struct CustomerService { //PB ep84 1mins
   ...
   static internal func addCustomer(name: String, email: String, password: String) -> Customer { //PB ep85 24mins register method
   ...
   static func addAddress(forCustomer customer: Customer, address1: String, address2: String, city: String, state: String, zip: String, phone: String) -> Address { //PB ep90 6mins takes a customer and addresses and return an Address entity
   ...
   static func addCreditCard(forCustomer customer: Customer, nameOnCard: String, cardNumber: String, expMonth: Int, expYear: Int) -> CreditCard { //PB ep91 16mins method to add CreditCard

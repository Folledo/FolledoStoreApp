...
class AppDelegate: UIResponder, UIApplicationDelegate {
   ...
   var coreDataStack = CoreDataStack() //PB ep 9 0mins it set up the persistentContainer and save the data if there are any changes. As AppDelegate is the first file that executes as soon as app launched, we can save and fetch the context the from the Core Data Stack.
   ...
   func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
      ...
      let productDetailVC = detailNavigation.topViewController as! ProductDetailViewController //PB ep68 20mins
